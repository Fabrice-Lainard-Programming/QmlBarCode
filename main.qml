...
ApplicationWindow
{
    ...
    }  Text
    {
        ...
        z: 50
        color: "#ff5177"
        text: "FoodTime Detected Tag: " + detectedTags
    }
    Text
    {
        id: fps
    ...
    QZXingFilter
    {
        ...
        decoder {
            enabledDecoders: QZXing.DecoderFormat_CODE_128_GS1 | QZXing.DecoderFormat_EAN_13 | QZXing.DecoderFormat_CODE_39 | QZXing.DecoderFormat_QR_CODE
